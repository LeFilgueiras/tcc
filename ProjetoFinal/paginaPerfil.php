		...
		<div>
			...
			<fieldset id="divperfil">
			 <legend>Perfil do Usuário</legend>
			 	<form enctype="multipart/form-data" action="funcoesPerfil.php" method="post">

					<?php
          $dados = PegaDados($idAluno);
								foreach ($dados as $dado) { ?>

				  <label for="imagem"><b>Imagem de perfil:</b></label>
				 	<div id="foto"> (inserir a imagem)</div>
				  <input type="file" accept="image/jpeg" name="imagem" ><br><br>
          <input type="submit" name="imagemenviar" value="Enviar"/>
